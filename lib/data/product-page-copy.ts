...
export const productPageCopy = {
  ...
  why: {
    ...
    cards: [
      ...
      { title: "مزامنة تلقائية مع التطبيق", body: "النتائج كتوصل فثواني عبر بلوتوث." },
  ...
  bia: {
    eyebrow: "تحليل الجسم",
    title: "تحليل الجسم — مرة واحدة، بوضوح.",
  ...
  app: {
    ...
    playStoreLabel: "تحميل أندرويد",
    appStoreLabel: "تحميل آيفون",
